...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.logo.setPixmap(QPixmap(u"../assets/Logo3.png"))
...
" border-radius: 20px;")
        ...
        self.showPasswordCheckbox = QCheckBox(self.widget_2)
        self.showPasswordCheckbox.setObjectName(u"showPasswordCheckbox")
        self.showPasswordCheckbox.setStyleSheet(u"margin-right:160px;\n"
"color:white;")

        self.verticalLayout_2.addWidget(self.showPasswordCheckbox, 0, Qt.AlignmentFlag.AlignHCenter)
...
" border-radius: 30px;")
    ...
    def retranslateUi(self, LoginWindow):
        ...
        self.showPasswordCheckbox.setText(QCoreApplication.translate("LoginWindow", u"Show Password", None))
